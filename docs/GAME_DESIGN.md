...
| MOB-038 | `minecraft:pig` | Truffle Pig | Farm animal that can discover buried ingredients. |
| MOB-039 | `minecraft:piglin` | Fudge Folk | Nether society, barter, equipment, and structure role. |
| MOB-040 | `minecraft:piglin_brute` | Fudge Brute | Burnt-Toffee Foundry elite defender. |
| MOB-041 | `minecraft:pillager` | Biscuit Bandit | Raid and outpost ranged role. |
| MOB-042 | `minecraft:polar_bear` | Vanilla-Ice Bear | Protective tundra animal. |
| MOB-043 | `minecraft:pufferfish` | Fizzball Fish | Inflating soda-ocean creature using pushback below Hard. |
| MOB-044 | `minecraft:rabbit` | Gummy Bunny | Small breedable flavour-variety animal. |
| MOB-045 | `minecraft:ravager` | Gingerbread Stomper | Large raid mount and obstacle-breaking spectacle with safe lower-difficulty rules. |
| MOB-046 | `minecraft:salmon` | Sherbet Salmon | Migratory cool-water food fish. |
