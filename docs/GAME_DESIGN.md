...
| STRUCT-018 | `minecraft:bastion_remnant` | Burnt-Toffee Foundry | Verified functional first conversion. CakeWorld deliberately reuses native `minecraft:bastion_remnant` and its weight-three place in the shared `minecraft:nether_complexes` set beside weight-two Fortresses, adding Fudge Wastes to native eligibility and exposing CakeWorld biome/configured-structure locate tags rather than registering a competing `27/4/30084232` linear placement. A persistent one-time, chunk- and piece-bounded palette preserves the complete depth-six Jigsaw graph, all 167 native templates and the four equal-weight bridge, hoglin-stable, treasure and housing starts: Blackstone becomes Burnt-Sugar Rock; Blackstone-Brick, cracked, stair, slab, wall, chiseled and gilded forms become a harvestable Burnt-Toffee masonry family; and Basalt keeps its axis as Burnt-Toffee Pillars. Gold Blocks, Lava, Magma, chains, lanterns, Soul Sand, Nether Wart, Quartz, all four native chest-loot tables, guaranteed bridge Lodestone loot, Netherite/Ancient-Debris progression and the treasure-room Magma Cube spawner remain authoritative. Gilded Burnt Toffee copies native Gilded Blackstone's Silk Touch and Fortune-scaled Gold-Nugget behavior. Fresh exact-type Piglins, Piglin Brutes and Hoglins continue through the existing Fudge Folk, Fudge Brute and Fudge Boar replacement boundaries without changing loaded, outside-biome or third-party entities. Original structure textures, bespoke geometry, sounds and hands-on navigation/combat/accessibility review remain; the first implementation uses clearly temporary vanilla texture stand-ins. |
...
| STRUCT-022 | Expansion | 5 | Crater Kitchen | Planned functional prototype: a dedicated quiet End ruin that cuts a safe stepped crater, reveals supported ancient crumbs, provides an accessible Wafer descent to a broken Macaron kitchen and lunar dial, and protects a rare Mooncake recipe cache. Meringue Islands is the explicit proving ground until Mooncake Barrens exists; the final biome must own the mature variants and ambience. |
| STRUCT-023 | Core | 2 | Rock-Candy Crystal Mine | Functional first prototype: a peaceful, independently saved and locatable `33 x 49 x 33` geology gallery rather than a second mineshaft. Its `80/32/1978023` linear placement selects broad Marshmallow-Peaks terrain; a Biscuit-Stone, Candy-Cane, Wafer and Icing headframe remains visible above a continuous 35-rung supported ladder, four recovery ledges and a nine-block Marshmallow landing. The lit central cavern adds five more cushions and four colour-readable host-family wings: Biscuit/Wafer sedimentary, Peppermint intrusive, Rock-Candy/Nougat metamorphic and Fudge/Burnt-Sugar volcanic. Authored Cocoa-Cloud, Liquorice-Vein, precise Mint-Crystal, compact Rock-Candy and weighted Sprinkle silhouettes teach the pattern vocabulary, while a modest cache guarantees a pickaxe, torches, food and recovery blocks. These exhibits are not presented as evidence that OreSpawn generated those exact authored blocks; fixed-world surveys remain authoritative for runtime geology and pattern proof. Marshmallow Peaks is the explicit temporary proving ground until Rock-Candy Caverns exists. Original presentation, signage/sounds and hands-on navigation/accessibility review remain. |
