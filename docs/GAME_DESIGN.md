...
| MOB-043 | `minecraft:pufferfish` | Fizzball Fish | Inflating soda-ocean creature retaining Pufferfish inflation, bucket, loot, Axolotl-prey and poison roles; below Hard its sting becomes a visible, poison-free, landing-safe fizzy pushback. |
