...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-034 | Forge biome registration helper | Start simple biomes with `copyAndRegister`; Gingerbread Hearthlands, Cookie Crumb Forest, Peppermint Pinewoods, Gummy Jungle, and Caramel Bogs demonstrate copying complete Plains, Forest, Snowy-Taiga, Bamboo-Jungle, and Swamp definitions while deliberately replacing climate and ambient additions. Use `blankAndRegister` only for intentionally complete advanced definitions. | Main | 1/3 | Direct registry tests prove Hearthlands retains `0.85/0.55`, Cookie Forest `0.7/0.8`, Pinewoods `-0.2/0.7`, Gummy Jungle `0.95/0.95`, and Caramel Bogs `0.8/0.9`; each retains its named ambience and exact intended inherited spawn roles without leaking literal vanilla counterparts. |
...
| OS-044 | Weighted output biomes | Gingerbread Hearthlands enters the Overworld-land palette at weight `2.5`, alongside common Candy Plains and above the `2.0` Cookie Forest, `1.5` Peppermint Pinewoods, `1.5` Caramel Bogs, `1.25` Gummy Jungle, and less-common Marshmallow Peaks; later Cupcake Gardens or Jellybean islands become the rare classes. | Main | 3 | The revision-16 profile retains every populated weight. Fresh/reload sampling observed 2,642 Hearthlands, about 3,469 Cookie-Forest, 5,329 Pinewoods, about 3,705 Gummy-Jungle, and 3,817 Caramel-Bogs columns; broader statistical tolerance remains part of the final palette audit. |
| OS-045 | Similar-biome matching | Gingerbread Hearthlands maps optionally to Plains, Sunflower Plains, and Meadow; Cookie Forest to Forest, Flower Forest, and Birch Forest; Peppermint Pinewoods to Snowy Taiga, Taiga, and Old-Growth Pine Taiga; Gummy Jungle to Bamboo Jungle, Jungle, and Sparse Jungle; Caramel Bogs to Swamp. Each hint remains optional rather than becoming a hard dependency. | Main | 1/3 | Revision 16 retains all five hint sets with empty required-hint lists; accepted fresh/reload fixed-world sampling observed every mapped CakeWorld biome, including 3,817 Caramel-Bogs columns. A missing optional-hint fixture remains for the Sampler. |
...
| OS-047 | Temperature and downfall ranges | Gingerbread Hearthlands demonstrates a temperate selector (`0.4..1.2` temperature, `0.25..0.8` downfall); Cookie Forest narrows the wet edge (`0.15..1.5`, `0.55..1.0`); Peppermint Pinewoods supplies a cold/wet window (`-2.0..0.3`, `0.35..1.0`); Gummy Jungle supplies a tropical window (`0.7..2.0`, `0.7..1.0`); Caramel Bogs adds a saturated warm-wet window (`0.5..1.2`, `0.75..1.0`). Sherbet Dunes later adds the dry extreme. | Main | 1/3 | Revision 16 retains all five selector contracts and fresh/reload selection observes every biome; boundary fixtures at min/max and just outside them remain. |
| OS-048 | Surface top block | Use icing turf, sponge, crumb sand, fudge crust, meringue, elastic Gummy and sticky Caramel-Crust signatures. Gingerbread Hearthlands uses gravity-affected Biscuit Crumbs, Cookie Forest uses Chocolate Sponge, Peppermint Pinewoods uses Icing Layers, Gummy Jungle uses Gummy Blocks beneath its bounce-grove ecology, and Caramel Bogs uses Caramel Crust beneath its mangroves. | Main | 1/3/4/5 | Revision-16 fresh/reload sampling retained 1,859 Hearthlands crumb tops, about 1,373 Cookie-Sponge tops, 1,196 Pinewoods Icing-Layer tops, 1,494 Gummy tops, and 2,544 Caramel-Crust tops, alongside green Candy, Marshmallow, Fudge, and Meringue controls. |
| OS-049 | Surface filler block and depth | Put Chocolate Sponge four blocks below Hearthlands crumbs, four below Gummy Jungle, four below Caramel Bogs, and five below Cookie Forest, with five blocks of Peppermint Rock below Pinewoods icing and deeper biome-specific edible layers elsewhere. | Main | 1/3/4/5 | Revision 16 retains every declared depth; fresh/reload sampling exposed 9,253 Hearthlands Sponge cells, about 7,960 Cookie-Forest Sponge cells, 6,407 Gummy-Jungle Sponge cells, 13,933 Caramel-Bogs Sponge cells, and 16,994 Pinewoods Peppermint-Rock cells while all other dry/realm controls remained green. |
| OS-050 | Underwater surface block | Use Biscuit Crumbs beneath Soda Ocean, Blueberry Gummy beneath Gummy Jungle water, Caramel Crust beneath Caramel-Bogs Lemonade, and later custard sediment along Custard Coast. | Main | 3 | Revision 16 retains all three live biome fields; the fixed Lemonade floor retained about 14,688 Biscuit Crumbs across fresh/reload, and Caramel Bogs retained its Caramel-Crust wetland surface around the natural Cottage and mangrove. A deliberately flooded Gummy surface fixture remains useful final presentation evidence. |
