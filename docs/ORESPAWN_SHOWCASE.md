...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-034 | Forge biome registration helper | Start simple biomes with `copyAndRegister`; Gingerbread Hearthlands, Cookie Crumb Forest, Peppermint Pinewoods, Gummy Jungle, Caramel Bogs, Sherbet Dunes, Candy-Cane Badlands and Marshmallow Peaks demonstrate copying complete Plains, Forest, Snowy-Taiga, Bamboo-Jungle, Swamp, Desert, Badlands and Jagged-Peaks definitions while deliberately replacing climate, ambience and spawn roles. Use `blankAndRegister` only for intentionally complete advanced definitions. | Main | 1/3 | Direct registry tests prove Hearthlands `0.85/0.55`, Cookie Forest `0.7/0.8`, Pinewoods `-0.2/0.7`, Gummy Jungle `0.95/0.95`, Caramel Bogs `0.8/0.9`, Sherbet Dunes `2.0/0.0`, Candy-Cane Badlands `2.0/0.0` and Marshmallow Peaks `-0.3/0.5`; each retains its intended inherited source roles while substituting exact CakeWorld creatures. |
...
| OS-047 | Temperature and downfall ranges | Gingerbread Hearthlands demonstrates a temperate selector (`0.4..1.2` temperature, `0.25..0.8` downfall); Cookie Forest narrows the wet edge (`0.15..1.5`, `0.55..1.0`); Peppermint Pinewoods supplies a cold/wet window (`-2.0..0.3`, `0.35..1.0`); Marshmallow Peaks broadens the cold mountain selector (`-2.0..0.35`, `0.0..1.0`); Gummy Jungle supplies a tropical window (`0.7..2.0`, `0.7..1.0`); Caramel Bogs adds a saturated warm-wet window (`0.5..1.2`, `0.75..1.0`); Sherbet Dunes and Candy-Cane Badlands supply the dry extreme (`1.5..2.0`, `0.0..0.2`). | Main | 1/3 | Revision 19 retains all eight selector contracts and fixed-world fresh/reload selection observed every biome; boundary fixtures at min/max and just outside them remain. |
| OS-048 | Surface top block | Use icing turf, sponge, crumb sand, fudge crust, meringue, elastic Gummy, sticky Caramel Crust, four-colour Sherbet and Wafer-mesa signatures. Gingerbread Hearthlands uses gravity-affected Biscuit Crumbs, Cookie Forest uses Chocolate Sponge, Peppermint Pinewoods and Marshmallow Peaks use Icing Layers, Gummy Jungle uses Gummy Blocks beneath its bounce-grove ecology, Caramel Bogs uses Caramel Crust beneath its mangroves, Sherbet Dunes uses Raspberry Sherbet Powder beneath its fossils, and Candy-Cane Badlands uses Wafer Rock beneath its hoodoos. | Main | 1/3/4/5 | Revision-19 declarations and direct tests retain every named top material; fixed fresh/reload sampling observed 2,132 Icing tops across 2,231 Marshmallow-Peaks columns beside the natural bridge. |
| OS-049 | Surface filler block and depth | Put Chocolate Sponge four blocks below Hearthlands crumbs, Gummy Jungle and Caramel Bogs, and five below Cookie Forest; put five blocks of Peppermint Rock below Pinewoods icing, five blocks of Marshmallow below Peaks icing, five blocks of Lemon Sherbet Powder below Dunes, and seven blocks of Candy-Cane Pillar below Badlands mesa tops. | Main | 1/3/4/5 | Revision 19 retains every declared depth and direct tests prove the new Peaks band. Fixed fresh/reload scans observed 10,061 Marshmallow filler cells while retaining all earlier controls. |
| OS-050 | Underwater surface block | Use Biscuit Crumbs beneath Soda Ocean and Marshmallow Peaks, Blueberry Gummy beneath Gummy Jungle water, Caramel Crust beneath Caramel-Bogs Lemonade, Orange Sherbet Powder beneath Dunes fluid, Peppermint Rock beneath Badlands fluid, and later custard sediment along Custard Coast. | Main | 3 | Revision 19 retains all six live biome fields; direct profile and fixed surface tests retain the Peaks field and every earlier wet-surface control. A deliberately flooded Gummy fixture remains useful final presentation evidence. |
