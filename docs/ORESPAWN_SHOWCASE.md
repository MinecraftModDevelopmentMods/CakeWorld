...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-034 | Forge biome registration helper | Start simple biomes with `copyAndRegister`; Gingerbread Hearthlands, Cookie Crumb Forest, Peppermint Pinewoods, Gummy Jungle, Caramel Bogs, Sherbet Dunes, Candy-Cane Badlands, Marshmallow Peaks, Ice-Cream Tundra and Waffle Plateaus demonstrate copying complete Plains, Forest, Snowy-Taiga, Bamboo-Jungle, Swamp, Desert, Badlands, Jagged-Peaks, Snowy-Plains and Savanna-Plateau definitions while deliberately replacing climate, ambience and spawn roles. Use `blankAndRegister` only for intentionally complete advanced definitions. | Main | 1/3 | Direct registry tests prove the ten copied climates, including Waffle Plateaus `0.9/0.1`; each retains its intended inherited source roles while substituting exact CakeWorld creatures. Fixed-seed fresh/reload generation confirms the Waffle copy participates in the live overlay and persists. |
...
| OS-044 | Weighted output biomes | Gingerbread Hearthlands enters the Overworld-land palette at weight `2.5`, alongside Candy Plains and above the `2.0` Cookie Forest, `1.5` Peppermint Pinewoods, `1.5` Caramel Bogs, `1.25` Gummy Jungle, `1.25` Sherbet Dunes, `1.25` Candy-Cane Badlands, `1.0` Marshmallow Peaks, `1.0` Ice-Cream Tundra and `0.75` Waffle Plateaus; later Cupcake Gardens or Jellybean islands become additional entries. | Main | 3 | The revision-21 profile retains every populated weight, both generated adventure templates are identical outside the thirteen intended BaseMetals ore additions, and fixed-seed generation selected Waffle Plateaus. Weight affects candidates that overlap for the same source; it is not falsely presented as a global rarity promise for disjoint similar-biome sets. |
| OS-045 | Similar-biome matching | Gingerbread Hearthlands maps optionally to Plains, Sunflower Plains, and Meadow; Cookie Forest to Forest, Flower Forest, and Birch Forest; Peppermint Pinewoods to Snowy Taiga, Taiga, and Old-Growth Pine Taiga; Gummy Jungle to Bamboo Jungle, Jungle, and Sparse Jungle; Caramel Bogs to Swamp; Sherbet Dunes to Desert; Candy-Cane Badlands to Badlands, Eroded Badlands and Wooded Badlands; Marshmallow Peaks to Jagged Peaks, Frozen Peaks, Stony Peaks, Snowy Slopes and Grove; Ice-Cream Tundra to Snowy Plains, Ice Spikes and Snowy Beach; Waffle Plateaus to Savanna Plateau, Windswept Savanna and Savanna. Each hint remains optional rather than becoming a hard dependency. | Main | 1/3 | Revision 21 retains all ten hint sets with empty required-hint lists; the Waffle fixed-seed world proves its optional Savanna family can select the new output. A missing optional-hint fixture remains for the Sampler. |
