...
settings cannot drift. Provider revision 43 currently packages the three
...
| OS-032 | Biome rules and biome-dictionary matching | Bias geomes using exact CakeWorld biome IDs plus Forge COLD and HOT dictionary names; retain an unmatched MUSHROOM control. Nougat Depths, Jam Grottoes and Rock-Candy Caverns use exact `8/20`, `18/6` and `4/20` cave rules. Fudge Wastes, Burnt-Toffee Deltas, Cinnamon Ember Groves, Black-Liquorice Labyrinths, Treacle Soul Valleys, Chilli-Chocolate Crags and Molten-Marshmallow Calderas add exact `12`, `20`, `16`, `18`, `14`, `28` and `22` Fudge-Mantle rules while retaining their declared Nether types. Meringue Islands and Candyfloss Cloudbanks each use exact `12/4`, Mooncake Barrens uses exact `10/6`, and Starlight Sugar Fields uses exact `8/12` Meringue-Crust/Rock-Candy-Uplift bias while retaining END, VOID, MAGICAL and PLAINS identity. Peppermint Pinewoods, Marshmallow Peaks and Ice-Cream Tundra combine exact cold-biome rules with COLD identity. Waffle Plateaus, Cupcake Gardens, Liquorice Darkwood, Lollipop Orchards, Popcorn Prairie, Soda Ocean, Custard Coast, Jellybean Archipelago, Gummy Jungle, Caramel Bogs, Sherbet Dunes and Candy-Cane Badlands retain their previously verified exact-ID and dictionary contracts. The dry Overworld biomes deliberately retain the additive HOT/Fudge-Mantle seam. | Main | 2/4/5 | The active revision-43 profile retains exact-ID and dictionary forms and registered types match only intended biomes. Direct tests prove all thirty-one exact biome contracts, including Starlight's `8/12` rule. Fixed seed `5059928472718672684` selected End Midlands into Starlight Sugar Fields and retained independent Rock-Candy geology across normal and BaseMetals fresh/reload worlds; exact geome ratios remain declarative rather than being inferred from one bounded region. |
...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-034 | Forge biome registration helper | Start simple biomes with `copyAndRegister`; the thirty previously verified CakeWorld biomes copy complete vanilla source definitions rather than recreating hidden generation state. Starlight Sugar Fields adds the thirty-first definition by copying End Midlands and replacing climate, ambience and spawn roles while retaining the source's generation contract. Use `blankAndRegister` only for intentionally complete advanced definitions. | Main | 1/2/3/4/5 | Direct registry tests prove all thirty-one copied climates, including all seven Nether outputs at `2.0/0.0`, all four End outputs at `0.5/0.0`, Nougat Depths `0.6/0.5`, Jam Grottoes `0.7/0.9`, Rock-Candy Caverns `0.8/0.4`, Soda Ocean `0.5/0.5`, Custard Coast `0.8/0.4` and Jellybean Archipelago `0.9/1.0`. Fixed-seed generation selects each copied biome through the live three-dimensional overlay and preserves exact-save identity; Starlight's End-Midlands definition returned at `2052,57,11` in normal and BaseMetals fresh/reload worlds. |
...
| OS-044 | Weighted output biomes | Gingerbread Hearthlands enters the Overworld-land palette at weight `2.5`, alongside Candy Plains and the previously verified complete land, ocean and cave palettes. The Nether palette selects Burnt-Toffee Deltas at `1.5`, Cinnamon Ember Groves at `1.25`, Treacle Soul Valleys at `1.2`, Black-Liquorice Labyrinths at `1.1`, Fudge Wastes at `1.0`, Molten-Marshmallow Calderas at `0.8` and Chilli-Chocolate Crags at `0.65`. The End palette selects Meringue Islands at `1.0`, Starlight Sugar Fields at `1.25`, Mooncake Barrens at `1.5` and Candyfloss Cloudbanks at `2.0`; their source families are disjoint, so these remain profile weights rather than global area-ratio promises. | Main | 2/3/4/5 | Revision 43 retains every populated cave, land, ocean, Nether and four-biome End weight. The normal and BaseMetals templates are generated from the same canonical profile and differ only by the thirteen declared compatibility ores. Weight affects overlapping candidates; it is not falsely presented as a global rarity guarantee for disjoint source families. |
| OS-045 | Similar-biome matching | The twenty-nine previously verified copied-biome hint rules remain optional rather than becoming hard dependencies. Starlight Sugar Fields adds the thirtieth optional exact hint, `minecraft:end_midlands`; Meringue Islands continues to leave its hint list empty to demonstrate selection by the remaining palette and climate contracts. Every required-hint list remains empty in the adventure. | Main | 1/2/3/4/5 | Revision 43 retains all thirty optional copied-biome hint rules with empty required-hint lists. Fixed-seed normal and BaseMetals fresh/reload worlds selected Starlight through End Midlands at the same centre, while the separate missing-optional-hint fixture remains for the Sampler. |
...
| OS-047 | Temperature and downfall ranges | The thirty previously verified selectors retain their complete source-inclusive or deliberately narrow climate windows. Starlight Sugar Fields adds the thirty-first selector: the complete End-Midlands source range (`-2.0..2.0` temperature, `0.0..1.0` downfall) mapped to a registered `0.5/0.0` output, matching the other three End dreamscapes without narrowing away valid source cells. | Main | 1/2/3/4/5 | Revision 43 retains all thirty-one selector contracts. Fixed-seed normal and BaseMetals fresh/reload worlds selected Starlight at the same End-Midlands-derived location and retained the registered climate. Exact boundary fixtures for every range remain, including the prior Waffle proof that selectors evaluate source rather than output climate. |
| OS-048 | Surface top block | The adventure uses distinct registered top materials for every surface biome while the three underground biomes deliberately omit the surface object. Revision 43 adds Starlight Sugar Grass as the luminous full-block top of Starlight Sugar Fields beside the already verified Meringue Foam, Candyfloss Cloud and Mooncake Crust End signatures. | Main | 1/3/4/5 | Direct tests retain every named top material and all three cave omissions. Fixed normal fresh/reload evidence retained `1,466` independent Starlight-Sugar-Grass cells around the natural Observatory; the BaseMetals pair retained the same count while independently adding Starsteel. Earlier slice evidence retains each other top-material count and literal-source negative. |
| OS-049 | Surface filler block and depth | Every surface output declares an edible filler and exact depth. Revision 43 adds four-deep Rock Candy below Starlight Sugar Grass, alongside the previously verified five-deep Marshmallow below Meringue Foam, four-deep Candyfloss Cloud below Cloudbanks and five-deep Biscuit Stone below Mooncake Crust. | Main | 1/3/4/5 | Direct tests prove every exact declaration. Normal fresh/reload retained `10,160` Rock-Candy and `3,597` Nougat cells in the bounded Starlight audit; BaseMetals retained `10,157` Rock Candy and the same Nougat while three eligible cells became part of the independently attributed Starsteel output. Counts are bounded observations; configured depth four is the exact contract. |
| OS-050 | Underwater surface block | Retain the seventeen previously verified biome-specific wet-edge materials and add Rock Candy beneath Starlight Sugar Fields, keeping underwater presentation explicit even in an ordinarily dry End source family. | Main | 3/5 | Revision 43 retains all eighteen live fields and direct profile tests retain every control. This declaration remains independent of the separately shelved automatic `ice_block` runtime in OS-056. |
...
| OS-102 | Surface-before-child-feature ordering | OreSpawn 4.0.6 applies provider-owned exposed-ground surfaces during `LOCAL_MODIFICATIONS`, before CakeWorld's ordinary decoration features author landmarks and vegetation. CakeWorld features therefore search bounded in-chunk safe sites, accept declared edible supports and relief, fill only clear support gaps, and reject fluids, block entities, ores, structures and unknown or player-authored solids. Ordering is not a resource-protection contract: structural landmark blocks remain excluded from managed host tags where required. Burnt-Toffee Deltas and Molten-Marshmallow Calderas retain their filtered copied-feature controls. The End now supplies four independent one-chunk cases—Meringue Star Landing, Cloudstep Lookout, Crumb Moon Dial and Sugar-Star Observatory—while the larger Crater Kitchen retains its nine-point Mooncake biome/support predicate. The Observatory additionally proves an exact horizontal telescope state survives all rotations without an entity, block entity, inventory, marker, repair or replay path, while optional Starsteel remains independently managed geology rather than authored scenery. | Main | 2/3/4/5 | Published release `4.0.6.118021`, CurseForge file `8688546`, remains the tested dependency. Revision 43 passed direct target tests plus normal and BaseMetals fixed fresh/reload evidence. The Observatory returned at `2052,57,11`, `CLOCKWISE_180`, with exact fresh `49/24/9/16/4/2/5/5/1/1` and reload `49/24/9/16/4/2/5/4/1/1+Brick` identity in both profiles; the normal region contained zero Starsteel and the BaseMetals region retained `15` naturally managed cells. Earlier slice evidence retains the Dial, Crater Kitchen and every named surface landmark. Direct tests cover placement bounds, support, relief, fluid, block-entity, obstacle, chunk-containment and facing controls. No OreSpawn source or local JAR was changed. |
...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-089 | Provider-owned multi-dimension fluid deposit | Six stable rules declare Jam, Custard, Caramel and Syrup in the Overworld plus Hot Fudge and Molten Mallow in the Nether. Revision 43 retains all seven CakeWorld Nether biomes in the one shared Hot-Fudge rule and the distinct `cakeworld:fluid_deposit/molten_mallow` rule available only in Molten-Marshmallow Calderas. | Main | 2/4 | Revision 43 bakes all six definitions across two dimensions. Direct tests retain the exact seven-biome Hot-Fudge allow-list and the independent Calderas-only Molten-Mallow filter. Fixed fresh/reload Fudge-Wastes evidence retained 42,264 Hot-Fudge cells outside its authored fountain; Burnt-Toffee retained 6,563, Black Liquorice 12,257, Treacle Soul Valleys 2,281 and Chilli-Chocolate Crags 85,739 in their independent audits; Calderas retained 29,977 Hot-Fudge cells plus 1,158 independently managed Molten-Mallow cells. The Jam-Grotto survey retained 1,960 managed Jam cells in the allowed Cookie-Forest region. |
...
| OS-095 | Fluid host blocks and tags | Restrict Jam through explicit Wafer Rock plus the metamorphic host family, Custard through the edible-host tag, Hot Fudge through volcanic edible hosts, and Molten Mallow through the `igneous_volcanic` family. | Main | 2/4 | Revision 43 retains the Jam host forms, volcanic Hot-Fudge hosts across all seven Nether biomes and the independent Molten-Mallow host family. All rules bake; Calderas fresh/reload retained 1,158 Molten-Mallow cells plus 29,977 Hot-Fudge cells, while strict negative-host proof resumes when the public API exposes a compiled acceptance predicate or deterministic deposit fixture. |
