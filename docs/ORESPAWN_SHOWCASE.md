...
| OS-032 | Biome rules and biome-dictionary matching | Bias geomes using exact CakeWorld biome IDs plus Forge COLD and HOT dictionary names; retain an unmatched MUSHROOM control. Peppermint Pinewoods combines an exact Peppermint-Fold/Rock-Candy rule with COLD identity. Gummy Jungle combines explicit Cocoa-Basin/Wafer-Shelf/Rock-Candy-Uplift weights with HOT identity, deliberately admitting the additive Fudge-Mantle seam. | Main | 2 | The active profile retains both rule forms and registered types match only intended biomes. Revision-15 fresh/reload sampling kept all 57 Pinewoods columns in Peppermint Fold and all 40 locally coherent Gummy columns in the valid HOT/Fudge-Mantle seam; direct profile checks retain Gummy's three exact weights as well. |
...
| OS-044 | Weighted output biomes | Gingerbread Hearthlands enters the Overworld-land palette at weight `2.5`, alongside common Candy Plains and above the `2.0` Cookie Forest, `1.5` Peppermint Pinewoods, `1.25` Gummy Jungle, and less-common Marshmallow Peaks; later Cupcake Gardens or Jellybean islands become the rare classes. | Main | 3 | The revision-15 profile retains every populated weight. Fresh/reload sampling observed 2,642 Hearthlands, 3,447 Cookie-Forest, 5,329 Pinewoods, and 3,699 Gummy-Jungle columns; broader statistical tolerance remains part of the final palette audit. |
| OS-045 | Similar-biome matching | Gingerbread Hearthlands maps optionally to Plains, Sunflower Plains, and Meadow; Cookie Forest to Forest, Flower Forest, and Birch Forest; Peppermint Pinewoods to Snowy Taiga, Taiga, and Old-Growth Pine Taiga; Gummy Jungle to Bamboo Jungle, Jungle, and Sparse Jungle. Each demonstrates several present hints without making any a hard dependency. | Main | 1/3 | Revision 15 retains all four hint sets with empty required-hint lists; accepted fresh/reload fixed-world sampling observed 2,642 Hearthlands, 3,447 Cookie-Forest, 5,329 Pinewoods, and 3,699 Gummy-Jungle columns. A missing optional-hint fixture remains for the Sampler. |
...
| OS-047 | Temperature and downfall ranges | Gingerbread Hearthlands demonstrates a temperate selector (`0.4..1.2` temperature, `0.25..0.8` downfall); Cookie Forest narrows the wet edge (`0.15..1.5`, `0.55..1.0`); Peppermint Pinewoods supplies a cold/wet window (`-2.0..0.3`, `0.35..1.0`); Gummy Jungle supplies the first tropical window (`0.7..2.0`, `0.7..1.0`). Sherbet Dunes later adds the dry extreme. | Main | 1/3 | Revision 15 retains all four selector contracts and fresh/reload selection observes every biome; boundary fixtures at min/max and just outside them remain. |
| OS-048 | Surface top block | Use icing turf, sponge, crumb sand, fudge crust, meringue, and elastic Gummy signatures. Gingerbread Hearthlands uses gravity-affected Biscuit Crumbs, Cookie Forest uses Chocolate Sponge, Peppermint Pinewoods uses Icing Layers, and Gummy Jungle uses Gummy Blocks beneath its bounce-grove ecology. | Main | 1/3/4/5 | Revision-15 fresh/reload sampling retained 1,859 Hearthlands crumb tops, 1,381 Cookie-Sponge tops, 1,163 Pinewoods Icing-Layer tops, and 1,632 Gummy tops, alongside green Candy, Marshmallow, Fudge, and Meringue controls. |
| OS-049 | Surface filler block and depth | Put Chocolate Sponge four blocks below Hearthlands crumbs, five below Cookie Forest, four below Gummy Jungle, and five blocks of Peppermint Rock below Pinewoods icing, with deeper biome-specific edible layers elsewhere. | Main | 1/3/4/5 | Revision 15 retains every declared depth; fresh/reload sampling exposed 9,253 Hearthlands Sponge cells, about 7,793 Cookie-Forest Sponge cells, 6,932 Gummy-Jungle Sponge cells, and 16,817 Pinewoods Peppermint-Rock cells while all other dry/realm controls remained green. |
| OS-050 | Underwater surface block | Use Biscuit Crumbs beneath Soda Ocean, Blueberry Gummy beneath Gummy Jungle water, and later custard sediment along Custard Coast. | Main | 3 | Revision 15 retains Gummy's Blueberry-Gummy field and Soda's three crumb fields; the fixed Lemonade floor retained about 14,690 Biscuit Crumbs across fresh/reload. A deliberately flooded Gummy surface fixture remains useful final presentation evidence. |
