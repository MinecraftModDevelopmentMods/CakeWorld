...
settings cannot drift. Provider revision 45 currently packages the three
...
| OS-032 | Biome rules and biome-dictionary matching | Bias geomes using exact CakeWorld biome IDs plus Forge dictionary identities. Revision 45 retains every earlier rule and adds Cosmic Jelly Reefs at exact `4/16` Meringue-Crust/Rock-Candy-Uplift bias with END, VOID, MAGICAL and RARE identity. | Main | 2/4/5 | Direct tests prove all thirty-three exact biome contracts. Fixed seed `5059928472718672684` selected End Midlands into Cosmic Jelly Reefs and retained independent Wafer, Rock-Candy and Nougat geology; declarative geome weights are not inferred from one bounded region. |
...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-034 | Forge biome registration helper | Use `copyAndRegister` for readable source-compatible definitions. The thirty-two earlier biomes retain their copied vanilla generation state; Cosmic Jelly Reefs adds the thirty-third definition by copying End Midlands and replacing climate, ambience and spawn roles. Use `blankAndRegister` only for intentionally complete advanced definitions. | Main | 1/2/3/4/5 | Direct registry tests prove all thirty-three copied climates, including seven Nether and six End outputs. Fixed fresh/reload generation selected Cosmic through the live overlay and retained its exact-save identity around the natural Nursery at `327,56,2057`. |
...
| OS-044 | Weighted output biomes | Retain all verified land, ocean, cave and Nether weights. Revision 45's End palette selects Cosmic Jelly Reefs at `0.6`, Macaron Archipelago at `0.75`, Meringue Islands at `1.0`, Starlight Sugar Fields at `1.25`, Mooncake Barrens at `1.5` and Candyfloss Cloudbanks at `2.0`. | Main | 2/3/4/5 | Normal and BaseMetals templates are generated from one canonical profile and differ only by thirteen compatibility ores. Direct tests prove all six End entries and weights; weights affect overlapping candidates and are not global area-ratio promises. |
| OS-045 | Similar-biome matching | Thirty-two copied-biome rules use optional exact hints with empty required lists; Cosmic Jelly Reefs adds `minecraft:end_midlands`, while Meringue Islands deliberately retains an empty hint list to demonstrate selection by the remaining palette and climate contract. | Main | 1/2/3/4/5 | Revision 45 retains every optional hint and empty required list. Fixed fresh/reload selected Cosmic through End Midlands; the Sampler keeps the separate missing-optional-hint fixture. |
...
| OS-047 | Temperature and downfall ranges | The thirty-two earlier selectors retain their source-inclusive or deliberately narrow climate windows. Cosmic Jelly Reefs adds the thirty-third selector with the complete End-Midlands source range (`-2.0..2.0` temperature, `0.0..1.0` downfall) mapped to registered `0.5/0.0`. | Main | 1/2/3/4/5 | Revision 45 direct tests retain all thirty-three selector contracts. Fixed fresh/reload selected Cosmic through its declared source window; exact boundary fixtures remain the completion gate for the showcase as a whole. |
| OS-048 | Surface top block | Every surface biome has a distinct registered top material while the three underground biomes deliberately omit `surface`. Revision 45 adds light-level-ten elastic Cosmic Jelly beside the five previously verified End signatures. | Main | 1/3/4/5 | Direct tests prove the declaration. Fixed fresh/reload retained `2,734` independent Cosmic-Jelly cells, including `2,525` natural Jelly cells directly above configured Rock-Candy filler. |
| OS-049 | Surface filler block and depth | Every surface output declares an edible filler and exact depth. Revision 45 adds four-deep Rock Candy beneath Cosmic Jelly alongside the five earlier End filler contracts. | Main | 1/3/4/5 | Direct tests prove the exact four-block declaration. Fixed fresh/reload retained `2,525` natural Jelly-over-Rock-Candy surface cells and `38,872` Rock-Candy cells in the bounded Cosmic region; counts are observations, while depth four is the exact contract. |
| OS-050 | Underwater surface block | Retain the nineteen verified wet-edge declarations and add Candy Glass beneath Cosmic Jelly Reefs, keeping underwater presentation explicit even in an ordinarily dry End source family. | Main | 3/5 | Revision 45 retains all twenty live fields and every cave omission. This declaration is source/runtime-bake evidence; earlier wet-world fixtures retain behavioural proof and OS-056 remains separately shelved. |
...
| OS-102 | Surface-before-child-feature ordering | OreSpawn 4.0.6 applies provider-owned exposed-ground surfaces during `LOCAL_MODIFICATIONS`, before CakeWorld's ordinary decoration features. CakeWorld landmarks use bounded, one-chunk searches, accept declared natural edible support, fill only clear gaps and reject fluids, block entities, ores, structures and authored solids. Cosmic Jelly Nursery adds the sixth End case: a sealed seven-by-seven Lemonade habitat inside a nine-by-nine safety envelope, with no entity, block entity, inventory, marker, repair or replay path. | Main | 2/3/4/5 | Published `4.0.6.118021` (CurseForge file `8688546`) remains the tested dependency. Revision 45 direct tests cover all rotations, relief, support, fluid, block-entity, obstacle and containment controls. Fresh found the Nursery at `327,56,2057`, `NONE`, with exact `49/52/27/1/1/1/1/25/4/1/1` identity amid `552,353/2,734/2,525/22/38,872/26,674` biome/Jelly/Jelly-over-filler/Wafer/Rock-Candy/Nougat observations; reload retained the same terrain and `49/52/27/1/1/1/1/25/3/1/1+Brick`. The rejected Small-End-Islands draft had only 18 safe sites among 18,560 reef centres; moving this child biome to End Midlands restored the full surface and landmark contract without editing OreSpawn. |
