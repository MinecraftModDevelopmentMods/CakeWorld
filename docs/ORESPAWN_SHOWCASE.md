...
settings cannot drift. Provider revision 42 currently packages the three
...
| OS-032 | Biome rules and biome-dictionary matching | Bias geomes using exact CakeWorld biome IDs plus Forge COLD and HOT dictionary names; retain an unmatched MUSHROOM control. Nougat Depths adds an exact `8/20` Peppermint-Fold/Rock-Candy-Uplift rule while accurately retaining OVERWORLD, UNDERGROUND, DENSE and MAGICAL identity. Jam Grottoes adds an exact `18/6` Cocoa-Basin/Wafer-Shelf rule while accurately retaining OVERWORLD, UNDERGROUND, LUSH, WET and MAGICAL identity. Rock-Candy Caverns adds an exact `4/20` Peppermint-Fold/Rock-Candy-Uplift rule while accurately retaining OVERWORLD, UNDERGROUND, MAGICAL and SPARSE identity. Fudge Wastes, Burnt-Toffee Deltas, Cinnamon Ember Groves, Black-Liquorice Labyrinths, Treacle Soul Valleys, Chilli-Chocolate Crags and Molten-Marshmallow Calderas add exact `12`, `20`, `16`, `18`, `14`, `28` and `22` Fudge-Mantle rules; Fudge and Deltas retain NETHER, HOT, DRY and WASTELAND identity, Cinnamon retains NETHER, HOT, DRY and FOREST identity, Black Liquorice retains NETHER, HOT, DRY, FOREST, DENSE and SPOOKY identity, Treacle retains NETHER, HOT, DRY, SPARSE, SPOOKY and WASTELAND identity, Chilli Chocolate retains NETHER, HOT, DRY, MOUNTAIN and WASTELAND identity, and Calderas retains NETHER, HOT, DRY, MOUNTAIN and MAGICAL identity. Meringue Islands and Candyfloss Cloudbanks each add an exact `12/4` Meringue-Crust/Rock-Candy-Uplift rule; Meringue retains END, VOID and MAGICAL identity, while Cloudbanks retains END, VOID, MAGICAL and RARE identity. Mooncake Barrens adds an exact `10/6` Meringue-Crust/Rock-Candy-Uplift rule while retaining END, VOID, DRY, SPARSE and WASTELAND identity. Peppermint Pinewoods combines an exact Peppermint-Fold/Rock-Candy rule with COLD identity. Marshmallow Peaks combines an exact `6/14` Peppermint-Fold/Rock-Candy-Uplift rule with its COLD, MOUNTAIN and PEAK identity. Ice-Cream Tundra combines an exact `9/7` Peppermint-Fold/Wafer-Shelf rule with COLD and SNOWY identity. Waffle Plateaus adds an exact `4/16` Cocoa-Basin/Wafer-Shelf rule while accurately retaining MOUNTAIN, HOT, DRY and SAVANNA identity. Cupcake Gardens adds an exact `12/8` Cocoa-Basin/Wafer-Shelf rule while accurately retaining OVERWORLD, PLAINS and LUSH identity. Liquorice Darkwood adds an exact `10/4` Cocoa-Basin/Wafer-Shelf rule while accurately retaining OVERWORLD, FOREST, DENSE and SPOOKY identity. Lollipop Orchards adds an exact `8/10` Cocoa-Basin/Wafer-Shelf rule while retaining OVERWORLD, FOREST and LUSH identity. Popcorn Prairie adds an exact `6/12` Cocoa-Basin/Wafer-Shelf rule while retaining OVERWORLD, PLAINS and DRY identity. Soda Ocean adds an exact `12/6` Wafer-Shelf/Rock-Candy-Uplift rule while retaining OVERWORLD, OCEAN and WATER identity. Custard Coast adds an exact `14/4` Wafer-Shelf/Cocoa-Basin rule while retaining OVERWORLD and BEACH identity. Jellybean Archipelago adds an exact `10/8` Wafer-Shelf/Rock-Candy-Uplift rule while retaining OVERWORLD, MAGICAL, RARE and LUSH identity without claiming Forge MUSHROOM identity. Gummy Jungle combines explicit Cocoa-Basin/Wafer-Shelf/Rock-Candy-Uplift weights with HOT identity, deliberately admitting the additive Fudge-Mantle seam. Caramel Bogs adds an exact equal `8/8` Cocoa-Basin/Wafer-Shelf bias while retaining Forge SWAMP and WET identity. Sherbet Dunes adds an exact `4/12` Wafer-Shelf/Rock-Candy-Uplift bias. Candy-Cane Badlands adds exact `6/10/14` Wafer-Shelf/Peppermint-Fold/Rock-Candy-Uplift weights. The dry biomes deliberately retain the additive HOT/Fudge-Mantle seam. | Main | 2/4/5 | The active revision-42 profile retains exact-ID and dictionary forms and registered types match only intended biomes. Direct tests prove the Fudge-Wastes, Burnt-Toffee, Cinnamon, Black-Liquorice, Treacle-Soul, Chilli-Chocolate and Molten-Marshmallow-Calderas, Meringue-Islands, Candyfloss-Cloudbanks, Mooncake-Barrens, Nougat, Jam, Caverns, Archipelago, Custard, Soda, Prairie, Orchard, Darkwood, Cupcake, Waffle, Tundra, Peaks and Badlands contracts. Fixed-seed worlds select their intended copied source families and retain final edible output around ordinary landmarks, while exact geome ratios remain declarative rather than being inferred from one small region. |
...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-034 | Forge biome registration helper | Start simple biomes with `copyAndRegister`; Gingerbread Hearthlands, Cookie Crumb Forest, Peppermint Pinewoods, Gummy Jungle, Caramel Bogs, Sherbet Dunes, Candy-Cane Badlands, Marshmallow Peaks, Ice-Cream Tundra, Waffle Plateaus, Cupcake Gardens, Liquorice Darkwood, Lollipop Orchards, Popcorn Prairie, Soda Ocean, Custard Coast, Jellybean Archipelago, Rock-Candy Caverns, Jam Grottoes, Nougat Depths, Fudge Wastes, Burnt-Toffee Deltas, Cinnamon Ember Groves, Black-Liquorice Labyrinths, Treacle Soul Valleys, Chilli-Chocolate Crags, Molten-Marshmallow Calderas, Meringue Islands, Candyfloss Cloudbanks and Mooncake Barrens demonstrate copying complete Plains, Forest, Snowy-Taiga, Bamboo-Jungle, Swamp, Desert, Badlands, Jagged-Peaks, Snowy-Plains, Savanna-Plateau, Sunflower-Plains, Dark-Forest, Birch-Forest, Plains, Ocean, Beach, Mushroom-Fields, Dripstone-Caves, Lush-Caves, a second deliberately distinct Dripstone-Caves definition, Nether Wastes, Basalt Deltas, Crimson Forest, Warped Forest, Soul Sand Valley, a second deliberately distinct Nether-Wastes definition, a second deliberately distinct Basalt-Deltas definition, End Highlands, Small End Islands and End Barrens while replacing climate, ambience and spawn roles. Use `blankAndRegister` only for intentionally complete advanced definitions. | Main | 1/2/3/4/5 | Direct registry tests prove the thirty listed copied climates, including all seven Nether outputs at `2.0/0.0`, all three End outputs at `0.5/0.0`, Nougat Depths `0.6/0.5`, Jam Grottoes `0.7/0.9`, Rock-Candy Caverns `0.8/0.4`, Soda Ocean `0.5/0.5`, Custard Coast `0.8/0.4` and Jellybean Archipelago `0.9/1.0`; each retains its intended source roles while substituting exact CakeWorld creatures and any documented deliberate additions. Fixed-seed generation selects these copied biomes through the live three-dimensional overlay; each slice separately proves exact-save persistence, including the second Basalt-Deltas definition at `88,43,-2072`, Small-End-Islands definition at `665,64,822` and End-Barrens definition at `-748,57,-793`. |
...
| OS-042 | Coverage | **Adventure half verified:** all five production palettes retain full `coverage=1.0`; partial coverage remains a labelled Sampler fixture. | Main/Sampler | 1/7 | Main fixed-world output and the active profile prove full coverage. Do not mark the combined capability complete until the partial Sampler percentage is measured. |
...
| OS-044 | Weighted output biomes | Gingerbread Hearthlands enters the Overworld-land palette at weight `2.5`, alongside Candy Plains and above the `2.0` Cookie Forest, `1.6` Custard Coast, `1.5` Peppermint Pinewoods, `1.5` Caramel Bogs, `1.25` Gummy Jungle, `1.25` Sherbet Dunes, `1.25` Candy-Cane Badlands, `1.25` Cupcake Gardens, `1.1` Popcorn Prairie, `1.0` Marshmallow Peaks, `1.0` Ice-Cream Tundra, `1.0` Lollipop Orchards, `1.0` Jellybean Archipelago, `0.9` Liquorice Darkwood and `0.75` Waffle Plateaus. The separate Overworld-ocean palette selects Soda Ocean at weight `1.0`. The three-dimensional cave palette selects Rock-Candy Caverns and Jam Grottoes at weight `1.0` and Nougat Depths at `0.75`. Rock-Candy and Nougat deliberately overlap on the same Dripstone-Caves source family, making their weights directly observable competition rather than separate rarity labels. The Nether palette selects Burnt-Toffee Deltas at `1.5`, Cinnamon Ember Groves at `1.25`, Treacle Soul Valleys at `1.2`, Black-Liquorice Labyrinths at `1.1`, Fudge Wastes at `1.0`, Molten-Marshmallow Calderas at `0.8` and Chilli-Chocolate Crags at `0.65`. The End palette selects Meringue Islands at weight `1.0`, Mooncake Barrens at `1.5` and Candyfloss Cloudbanks at `2.0`; their source families are disjoint, so those values remain profile weights rather than global area ratios. | Main | 2/3/4/5 | The revision-42 profile retains every populated cave, land, ocean, Nether and End weight and both generated adventure templates are identical outside the thirteen intended BaseMetals ore additions. Weight affects candidates that overlap for the same source; it is not falsely presented as a global rarity promise for disjoint similar-biome sets. |
| OS-045 | Similar-biome matching | Rock-Candy Caverns and Nougat Depths both map optionally and exactly to Dripstone Caves; Jam Grottoes maps to Lush Caves; Fudge Wastes maps to Nether Wastes; Burnt-Toffee Deltas maps to Basalt Deltas; Cinnamon Ember Groves maps to Crimson Forest; Black-Liquorice Labyrinths maps to Warped Forest; Treacle Soul Valleys maps to Soul Sand Valley; Chilli-Chocolate Crags maps to Nether Wastes; Molten-Marshmallow Calderas maps to Basalt Deltas; Candyfloss Cloudbanks maps to Small End Islands; Mooncake Barrens maps to End Barrens; Gingerbread Hearthlands and Popcorn Prairie to Plains, Sunflower Plains, and Meadow; Cookie Forest to Forest, Flower Forest, and Birch Forest; Peppermint Pinewoods to Snowy Taiga, Taiga, and Old-Growth Pine Taiga; Gummy Jungle to Bamboo Jungle, Jungle, and Sparse Jungle; Caramel Bogs to Swamp; Sherbet Dunes to Desert; Candy-Cane Badlands to Badlands, Eroded Badlands and Wooded Badlands; Marshmallow Peaks to Jagged Peaks, Frozen Peaks, Stony Peaks, Snowy Slopes and Grove; Ice-Cream Tundra to Snowy Plains, Ice Spikes and Snowy Beach; Waffle Plateaus to Savanna Plateau, Windswept Savanna and Savanna; Cupcake Gardens to Sunflower Plains, Flower Forest and Meadow; Liquorice Darkwood to Dark Forest; Lollipop Orchards to Birch Forest, Old-Growth Birch Forest and Flower Forest; Custard Coast to Beach, Snowy Beach and Stony Shore; Jellybean Archipelago to Mushroom Fields; Soda Ocean to all nine vanilla Ocean, Deep Ocean, cold, frozen, lukewarm and warm variants. Meringue Islands deliberately leaves its optional hint list empty, demonstrating a copied End output selected by the remaining palette and climate contracts. Each hint remains optional rather than becoming a hard dependency. | Main | 1/2/3/4/5 | Revision 42 retains all twenty-nine listed copied-biome hint rules with empty required-hint lists. Fixed-seed fresh/reload evidence retained Fudge Wastes, Burnt-Toffee Deltas, Cinnamon Ember Groves, Black-Liquorice Labyrinths, Treacle Soul Valleys, Chilli-Chocolate Crags, Molten-Marshmallow Calderas, Meringue Islands, Candyfloss Cloudbanks, Mooncake Barrens, Nougat Depths, Jam Grottoes, Rock-Candy Caverns, Soda Ocean, Custard Coast and Jellybean Archipelago selected through their intended palette contracts; a missing optional-hint fixture remains for the Sampler. |
...
| OS-047 | Temperature and downfall ranges | Jam Grottoes, Rock-Candy Caverns, Nougat Depths, Fudge Wastes, Burnt-Toffee Deltas, Cinnamon Ember Groves, Black-Liquorice Labyrinths, Treacle Soul Valleys, Chilli-Chocolate Crags, Molten-Marshmallow Calderas, Meringue Islands, Candyfloss Cloudbanks and Mooncake Barrens deliberately span their complete Lush-Caves, Dripstone-Caves, Nether-Wastes, Basalt-Deltas, Crimson-Forest, Warped-Forest, Soul-Sand-Valley or End source ranges (`-2.0..2.0`, `0.0..1.0`) while registering `0.7/0.9`, `0.8/0.4`, `0.6/0.5`, seven `2.0/0.0` Nether outputs, and three `0.5/0.0` End outputs. Gingerbread Hearthlands demonstrates a temperate selector (`0.4..1.2` temperature, `0.25..0.8` downfall); Cookie Forest narrows the wet edge (`0.15..1.5`, `0.55..1.0`); Cupcake Gardens adds a temperate wet garden window (`0.3..1.2`, `0.35..1.0`); Liquorice Darkwood adds a dense temperate-wet window (`0.4..1.0`, `0.6..1.0`); Lollipop Orchards adds a mild lush-forest window (`0.3..1.0`, `0.4..0.9`); Popcorn Prairie adds an open warm-dry window (`0.5..1.2`, `0.2..0.6`); Jellybean Archipelago adds a warm, saturated rare-island window (`0.5..1.2`, `0.8..1.0`) while registering a lush `0.9/1.0` output; Custard Coast spans the complete shore source family (`-1.0..2.0`, `0.0..1.0`) while registering a mild `0.8/0.4` output; Soda Ocean deliberately spans the complete vanilla source family (`-2.0..2.0`, `0.0..1.0`) while registering a mild `0.5/0.5` output; Peppermint Pinewoods supplies a cold/wet window (`-2.0..0.3`, `0.35..1.0`); Marshmallow Peaks broadens the cold mountain selector (`-2.0..0.35`, `0.0..1.0`); Ice-Cream Tundra adds a cold-plains window (`-2.0..0.2`, `0.0..0.8`); Waffle Plateaus supplies a dry Savanna selector (`0.5..2.0`, `0.0..0.35`) whose upper bound deliberately includes vanilla 1.18.2's `2.0` source temperature; Gummy Jungle supplies a tropical window (`0.7..2.0`, `0.7..1.0`); Caramel Bogs adds a saturated warm-wet window (`0.5..1.2`, `0.75..1.0`); Sherbet Dunes and Candy-Cane Badlands supply the dry extreme (`1.5..2.0`, `0.0..0.2`). | Main | 1/2/3/4/5 | Revision 42 retains all thirty listed selector contracts. Fixed-seed fresh/reload evidence retained Fudge Wastes, Burnt-Toffee Deltas, Cinnamon Ember Groves, Black-Liquorice Labyrinths, Treacle Soul Valleys, Chilli-Chocolate Crags, Molten-Marshmallow Calderas, Meringue Islands, Candyfloss Cloudbanks, Mooncake Barrens, Nougat Depths, Jam Grottoes, Rock-Candy Caverns and Jellybean Archipelago selected through source-inclusive windows with their registered climates. A prior diagnostic fresh world with Waffle's maximum at `1.4` found no match; expanding it to the vanilla Savanna source boundary `2.0` selected the biome, proving selectors evaluate source climate. Exact boundary fixtures for every range remain. |
| OS-048 | Surface top block | Use icing turf, sponge, crumb sand, fudge crust, meringue, Candyfloss Cloud, Mooncake Crust, elastic Gummy, sticky Caramel Crust, four-colour Sherbet, soft dark Liquorice Loam, bright Candied Soil, bright Popped-Corn Turf, soft Custard Pudding, Crunchy Toffee Ash, Cinnamon Crust, Black Liquorice Stone, Treacle Soul Crust, Chilli Chocolate Rock, Toasted Mallow Crust and two distinct Wafer signatures. Gingerbread Hearthlands and Soda Ocean use gravity-affected Biscuit Crumbs, Cookie Forest uses Chocolate Sponge, Peppermint Pinewoods, Marshmallow Peaks and Ice-Cream Tundra use Icing Layers, Cupcake Gardens uses solid Icing, Liquorice Darkwood uses Liquorice Loam, Lollipop Orchards uses Candied Soil, Popcorn Prairie uses Popped-Corn Turf beneath its renewable kernel patches, Custard Coast uses cushioning Custard Pudding beneath its shore kitchen, Jellybean Archipelago uses bright Raspberry Gummy beneath its compass picnics, Gummy Jungle uses Gummy Blocks beneath its bounce-grove ecology, Caramel Bogs uses Caramel Crust beneath its mangroves, Sherbet Dunes uses Raspberry Sherbet Powder beneath its fossils, Candy-Cane Badlands uses Wafer Rock beneath its hoodoos, Waffle Plateaus uses visibly gridded Wafer Blocks, Fudge Wastes uses Fudge Rock, Burnt-Toffee Deltas uses Crunchy Toffee Ash, Cinnamon Ember Groves uses Cinnamon Crust, Black-Liquorice Labyrinths uses Black Liquorice Stone, Treacle Soul Valleys uses Treacle Soul Crust, Chilli-Chocolate Crags uses Chilli Chocolate Rock, Molten-Marshmallow Calderas uses Toasted Mallow Crust, Meringue Islands uses Meringue Foam, Candyfloss Cloudbanks uses Candyfloss Cloud and Mooncake Barrens uses Mooncake Crust. Underground Jam Grottoes, Rock-Candy Caverns and Nougat Depths deliberately declare no surface object. | Main | 1/3/4/5 | Revision-42 declarations and direct tests retain every named top material and all three cave omissions. Fixed-seed fresh/reload evidence retained 5,868 Treacle-Soul-Crust cells across 732,229 Valley samples with zero literal Soul Sand or Soul Soil, and 3,402 Black-Liquorice-Stone cells across 425,532 Labyrinth samples with zero literal Warped source residue. Calderas retained 3,960 independent Toasted-Mallow-Crust cells; Meringue retained 17,791 independent Meringue-Foam cells; Cloudbanks retained 762 independent Candyfloss-Cloud cells; Mooncake Barrens retained 2,171 independent Mooncake-Crust cells. Earlier fixed evidence retained 540,755 Fudge-Rock cells across 819,200 Fudge-Wastes samples with zero literal Netherrack, 1,613 Crunchy-Toffee-Ash cells across 205,907 Deltas samples with zero eligible vanilla source residue, 2,472 Cinnamon-Crust cells across 312,188 Cinnamon-Grove biome samples, and 11,497 Chilli-Chocolate-Rock cells across 1,397,244 Crags samples. |
| OS-049 | Surface filler block and depth | Put Chocolate Sponge four blocks below Hearthlands crumbs, Gummy Jungle, Caramel Bogs, Cupcake Gardens, Lollipop Orchards, Popcorn Prairie and Jellybean Archipelago, and five below Cookie Forest and Liquorice Darkwood; put four blocks of Biscuit Crumbs below Soda Ocean and four blocks of Custard Pudding below Custard Coast; put five blocks of Peppermint Rock below Pinewoods icing, five blocks of Marshmallow below Peaks icing, five blocks of solid Icing below Tundra icing, five blocks of Lemon Sherbet Powder below Dunes, seven blocks of Candy-Cane Pillar below Badlands mesa tops, six blocks of Wafer Rock below Waffle-Plateau grids, five blocks of Fudge Rock below Fudge-Wastes, Cinnamon-Crust, Black-Liquorice-Stone, Treacle-Soul-Crust, Chilli-Chocolate-Rock and Toasted-Mallow-Crust tops, five blocks of Burnt-Sugar Rock below Burnt-Toffee-Deltas ash, five blocks of Marshmallow below Meringue Foam, four blocks of Candyfloss Cloud below Cloudbanks, and five blocks of Biscuit Stone below Mooncake Crust. | Main | 1/3/4/5 | Revision 42 retains every declared depth and direct tests prove each exact declaration. Fixed-seed fresh/reload evidence retained 362,442 Treacle-region Fudge-Rock cells, 540,755 Fudge-Wastes Fudge-Rock, 41,634 Burnt-Sugar, more than 225,000 Cinnamon-region Fudge-Rock, 269,003 Black-Liquorice-region, 914,916 Chilli-Chocolate-Crags-region, 205,599 Calderas-region Fudge-Rock cells, 88,512 Meringue-Islands Marshmallow cells, 762 Cloudbanks Candyfloss-Cloud cells and 11,258 Mooncake-Barrens Biscuit-Stone cells in the audited realm interiors; counts are bounded observations while the configured depths are exact declarations. |
| OS-050 | Underwater surface block | Use Biscuit Crumbs beneath Soda Ocean, Marshmallow Peaks, Waffle Plateaus and Popcorn Prairie, Custard Pudding along Custard Coast, Blueberry Gummy beneath Gummy Jungle and Jellybean-Archipelago water, Raspberry Gummy beneath Cupcake Gardens and Lollipop Orchards, vertical Liquorice Root beneath Darkwood fluid, Caramel Crust beneath Caramel-Bogs Lemonade, Orange Sherbet Powder beneath Dunes fluid, Peppermint Rock beneath Badlands fluid, Frozen Lemonade beneath Ice-Cream Tundra fluid, Marshmallow beneath Meringue Islands, Meringue Foam beneath Candyfloss Cloudbanks, and Biscuit Stone beneath Mooncake Barrens. | Main | 3/5 | Revision 42 retains all seventeen live biome fields and direct profile tests retain every control; fixed-seed fresh/reload evidence retained 976 Blueberry-Gummy wet-edge cells around the complete natural Compass Picnic. This declaration is independent of the separately shelved automatic `ice_block` runtime in OS-056. |
...
| OS-102 | Surface-before-child-feature ordering | OreSpawn 4.0.6 applies provider-owned exposed-ground surfaces during `LOCAL_MODIFICATIONS`, before CakeWorld's ordinary decoration features author landmarks and vegetation. Structural top surfaces use full blocks such as Icing; `icing_layer` remains the accumulating weather/snow material rather than structural ground. CakeWorld features must search a bounded in-chunk set of safe sites, accept their declared edible supports and terrain relief, and never depend on the older post-feature surface timing. Structural landmark blocks must also be excluded from OreSpawn host tags when they must never become managed deposits; ordering alone is not a resource-protection contract. Burnt-Toffee Deltas retain the separate safe copied-feature design: inherited cross-chunk Basalt/Blackstone/Gravel writers are filtered and native bounded equivalents are used, with no unload/save mutation or repair loop. Molten-Marshmallow Calderas reuse the filtered Basalt-Deltas foundation and demonstrate a bounded child landmark that may clear only a small allow-list of natural volcanic relief after requiring support and open-headroom controls; ores, fluids, structures, block entities and unknown or player-authored solids remain protected. Meringue Islands, Candyfloss Cloudbanks and Mooncake Barrens demonstrate the corresponding End cases: their one-chunk top-layer Star Landing, Cloudstep Lookout and Crumb Moon Dial search bounded natural relief, fill only clear support gaps and reject fluids, block entities and authored obstacles. The larger Crater Kitchen additionally requires all nine support samples around its saved centre to satisfy its configured Mooncake biome predicate before authoring its bounded bowl. | Main | 2/3/4/5 | Published release `4.0.6.118021`, CurseForge file `8688546`, remains the tested dependency. Revision 42 passed direct target tests and fixed-world fresh/reload evidence in the 260-test matrix: the Dial returned at `-748,57,-793`, `NONE`, with exact fresh `49/24/9/16/9/2/4/4/1/1` and reload `49/24/9/16/9/2/4/3/1/1+Brick` identity; the Crater Kitchen returned at `60544,52,-38992`, `CLOCKWISE_180`, remained centred in Mooncake Barrens and retained every functional check plus its deliberate Brick replacement. The natural Starter Picnic, Peppermint Clearing, Ice-Cream Sundae Rink, Cinnamon Hearth Grove, Candy-Cane Hoodoo Garden, Marshmallow Cloud Bridge, Mallow Steam Caldera, Meringue Star Landing, Cloudstep Lookout and Crumb Moon Dial all retained their complete authored layouts in their slice evidence. Direct tests cover placement bounds, support, relief, fluid, block-entity and obstacle controls. Cut Rock Candy remains outside the edible ore-host tag so Geode-Bridge rails cannot be replaced by managed deposits. No OreSpawn source or local JAR was changed. |
...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-089 | Provider-owned multi-dimension fluid deposit | Six stable rules declare Jam, Custard, Caramel and Syrup in the Overworld plus Hot Fudge and Molten Mallow in the Nether. Revision 42 retains all seven CakeWorld Nether biomes in the one shared Hot-Fudge rule and the distinct `cakeworld:fluid_deposit/molten_mallow` rule available only in Molten-Marshmallow Calderas. | Main | 2/4 | Revision 42 bakes all six definitions across two dimensions. Direct tests retain the exact seven-biome Hot-Fudge allow-list and the independent Calderas-only Molten-Mallow filter. Fixed fresh/reload Fudge-Wastes evidence retained 42,264 Hot-Fudge cells outside its authored fountain; Burnt-Toffee retained 6,563, Black Liquorice 12,257, Treacle Soul Valleys 2,281 and Chilli-Chocolate Crags 85,739 in their independent audits; Calderas retained 29,977 Hot-Fudge cells plus 1,158 independently managed Molten-Mallow cells. The Jam-Grotto survey retained 1,960 managed Jam cells in the allowed Cookie-Forest region. |
...
| OS-095 | Fluid host blocks and tags | Restrict Jam through explicit Wafer Rock plus the metamorphic host family, Custard through the edible-host tag, Hot Fudge through volcanic edible hosts, and Molten Mallow through the `igneous_volcanic` family. | Main | 2/4 | Revision 42 retains the Jam host forms, volcanic Hot-Fudge hosts across all seven Nether biomes and the independent Molten-Mallow host family. All rules bake; Calderas fresh/reload retained 1,158 Molten-Mallow cells plus 29,977 Hot-Fudge cells, while strict negative-host proof resumes when the public API exposes a compiled acceptance predicate or deterministic deposit fixture. |
