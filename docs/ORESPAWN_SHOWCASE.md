...
settings cannot drift. Provider revision 24 currently packages the two
...
| OS-047 | Temperature and downfall ranges | Gingerbread Hearthlands demonstrates a temperate selector (`0.4..1.2` temperature, `0.25..0.8` downfall); Cookie Forest narrows the wet edge (`0.15..1.5`, `0.55..1.0`); Cupcake Gardens adds a temperate wet garden window (`0.3..1.2`, `0.35..1.0`); Liquorice Darkwood adds a dense temperate-wet window (`0.4..1.0`, `0.6..1.0`); Lollipop Orchards adds a mild lush-forest window (`0.3..1.0`, `0.4..0.9`); Peppermint Pinewoods supplies a cold/wet window (`-2.0..0.3`, `0.35..1.0`); Marshmallow Peaks broadens the cold mountain selector (`-2.0..0.35`, `0.0..1.0`); Ice-Cream Tundra adds a cold-plains window (`-2.0..0.2`, `0.0..0.8`); Waffle Plateaus supplies a dry Savanna selector (`0.5..2.0`, `0.0..0.35`) whose upper bound deliberately includes vanilla 1.18.2's `2.0` source temperature; Gummy Jungle supplies a tropical window (`0.7..2.0`, `0.7..1.0`); Caramel Bogs adds a saturated warm-wet window (`0.5..1.2`, `0.75..1.0`); Sherbet Dunes and Candy-Cane Badlands supply the dry extreme (`1.5..2.0`, `0.0..0.2`). | Main | 1/3 | Revision 24 retains all thirteen selector contracts. A diagnostic fresh world with Waffle's maximum at `1.4` found no match; expanding it to the vanilla Savanna source boundary `2.0` selected the biome and persisted it on reload, proving selectors evaluate source climate rather than the child biome's overridden climate. Exact boundary fixtures for every range remain. |
| OS-048 | Surface top block | Use icing turf, sponge, crumb sand, fudge crust, meringue, elastic Gummy, sticky Caramel Crust, four-colour Sherbet, soft dark Liquorice Loam, bright Candied Soil and two distinct Wafer signatures. Gingerbread Hearthlands uses gravity-affected Biscuit Crumbs, Cookie Forest uses Chocolate Sponge, Peppermint Pinewoods, Marshmallow Peaks and Ice-Cream Tundra use Icing Layers, Cupcake Gardens uses solid Icing, Liquorice Darkwood uses Liquorice Loam, Lollipop Orchards uses Candied Soil beneath its renewable groves, Gummy Jungle uses Gummy Blocks beneath its bounce-grove ecology, Caramel Bogs uses Caramel Crust beneath its mangroves, Sherbet Dunes uses Raspberry Sherbet Powder beneath its fossils, Candy-Cane Badlands uses Wafer Rock beneath its hoodoos, and Waffle Plateaus uses visibly gridded Wafer Blocks. | Main | 1/3/4/5 | Revision-24 declarations and direct tests retain every named top material. Fixed-seed fresh/reload Orchard sampling retained 2,235 Candied-Soil tops across 2,303 local columns, verifying final generated output rather than treating JSON alone as runtime proof. |
| OS-049 | Surface filler block and depth | Put Chocolate Sponge four blocks below Hearthlands crumbs, Gummy Jungle, Caramel Bogs, Cupcake Gardens and Lollipop Orchards, and five below Cookie Forest and Liquorice Darkwood; put five blocks of Peppermint Rock below Pinewoods icing, five blocks of Marshmallow below Peaks icing, five blocks of solid Icing below Tundra icing, five blocks of Lemon Sherbet Powder below Dunes, seven blocks of Candy-Cane Pillar below Badlands mesa tops, and six blocks of Wafer Rock below Waffle-Plateau grids. | Main | 1/3/4/5 | Revision 24 retains every declared depth and direct tests prove each exact declaration. Fixed-seed fresh/reload Orchard sampling retained 9,239 Chocolate-Sponge cells beneath its Candied-Soil surface. |
| OS-050 | Underwater surface block | Use Biscuit Crumbs beneath Soda Ocean, Marshmallow Peaks and Waffle Plateaus, Blueberry Gummy beneath Gummy Jungle water, Raspberry Gummy beneath Cupcake Gardens and Lollipop Orchards, vertical Liquorice Root beneath Darkwood fluid, Caramel Crust beneath Caramel-Bogs Lemonade, Orange Sherbet Powder beneath Dunes fluid, Peppermint Rock beneath Badlands fluid, Frozen Lemonade beneath Ice-Cream Tundra fluid, and later custard sediment along Custard Coast. | Main | 3 | Revision 24 retains all eleven live biome fields and direct profile tests retain every control; Orchard fresh/reload generation proved the final Candied-Soil/Sponge profile and complete Tasting-Grove persistence. This declaration is independent of the separately shelved automatic `ice_block` runtime in OS-056. |
