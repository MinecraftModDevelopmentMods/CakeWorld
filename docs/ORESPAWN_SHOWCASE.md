...
settings cannot drift. Provider revision 26 currently packages the two
...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-034 | Forge biome registration helper | Start simple biomes with `copyAndRegister`; Gingerbread Hearthlands, Cookie Crumb Forest, Peppermint Pinewoods, Gummy Jungle, Caramel Bogs, Sherbet Dunes, Candy-Cane Badlands, Marshmallow Peaks, Ice-Cream Tundra, Waffle Plateaus, Cupcake Gardens, Liquorice Darkwood, Lollipop Orchards, Popcorn Prairie and Soda Ocean demonstrate copying complete Plains, Forest, Snowy-Taiga, Bamboo-Jungle, Swamp, Desert, Badlands, Jagged-Peaks, Snowy-Plains, Savanna-Plateau, Sunflower-Plains, Dark-Forest, Birch-Forest, Plains and Ocean definitions while deliberately replacing climate, ambience and spawn roles. Use `blankAndRegister` only for intentionally complete advanced definitions. | Main | 1/3 | Direct registry tests prove the fifteen copied climates, including Soda Ocean `0.5/0.5`; each retains its intended inherited source roles while substituting exact CakeWorld creatures. Fixed-seed fresh/reload generation confirms Soda Ocean and the earlier copied biomes participate in the live overlay and persist. |
...
| OS-044 | Weighted output biomes | Gingerbread Hearthlands enters the Overworld-land palette at weight `2.5`, alongside Candy Plains and above the `2.0` Cookie Forest, `1.5` Peppermint Pinewoods, `1.5` Caramel Bogs, `1.25` Gummy Jungle, `1.25` Sherbet Dunes, `1.25` Candy-Cane Badlands, `1.25` Cupcake Gardens, `1.1` Popcorn Prairie, `1.0` Marshmallow Peaks, `1.0` Ice-Cream Tundra, `1.0` Lollipop Orchards, `0.9` Liquorice Darkwood and `0.75` Waffle Plateaus. The separate Overworld-ocean palette selects Soda Ocean at weight `1.0`; later Jellybean islands become an additional entry. | Main | 3 | The revision-26 profile retains every populated land and ocean weight and both generated adventure templates are identical outside the thirteen intended BaseMetals ore additions. Weight affects candidates that overlap for the same source; it is not falsely presented as a global rarity promise for disjoint similar-biome sets. |
| OS-045 | Similar-biome matching | Gingerbread Hearthlands and Popcorn Prairie map optionally to Plains, Sunflower Plains, and Meadow; Cookie Forest to Forest, Flower Forest, and Birch Forest; Peppermint Pinewoods to Snowy Taiga, Taiga, and Old-Growth Pine Taiga; Gummy Jungle to Bamboo Jungle, Jungle, and Sparse Jungle; Caramel Bogs to Swamp; Sherbet Dunes to Desert; Candy-Cane Badlands to Badlands, Eroded Badlands and Wooded Badlands; Marshmallow Peaks to Jagged Peaks, Frozen Peaks, Stony Peaks, Snowy Slopes and Grove; Ice-Cream Tundra to Snowy Plains, Ice Spikes and Snowy Beach; Waffle Plateaus to Savanna Plateau, Windswept Savanna and Savanna; Cupcake Gardens to Sunflower Plains, Flower Forest and Meadow; Liquorice Darkwood to Dark Forest; Lollipop Orchards to Birch Forest, Old-Growth Birch Forest and Flower Forest; Soda Ocean to all nine vanilla Ocean, Deep Ocean, cold, frozen, lukewarm and warm variants. Each hint remains optional rather than becoming a hard dependency. | Main | 1/3 | Revision 26 retains all fifteen copied-biome rules with empty required-hint lists. Fixed-seed generation selected Soda Ocean from the complete source family; a missing optional-hint fixture remains for the Sampler. |
...
| OS-047 | Temperature and downfall ranges | Gingerbread Hearthlands demonstrates a temperate selector (`0.4..1.2` temperature, `0.25..0.8` downfall); Cookie Forest narrows the wet edge (`0.15..1.5`, `0.55..1.0`); Cupcake Gardens adds a temperate wet garden window (`0.3..1.2`, `0.35..1.0`); Liquorice Darkwood adds a dense temperate-wet window (`0.4..1.0`, `0.6..1.0`); Lollipop Orchards adds a mild lush-forest window (`0.3..1.0`, `0.4..0.9`); Popcorn Prairie adds an open warm-dry window (`0.5..1.2`, `0.2..0.6`); Soda Ocean deliberately spans the complete vanilla source family (`-2.0..2.0`, `0.0..1.0`) while registering a mild `0.5/0.5` output; Peppermint Pinewoods supplies a cold/wet window (`-2.0..0.3`, `0.35..1.0`); Marshmallow Peaks broadens the cold mountain selector (`-2.0..0.35`, `0.0..1.0`); Ice-Cream Tundra adds a cold-plains window (`-2.0..0.2`, `0.0..0.8`); Waffle Plateaus supplies a dry Savanna selector (`0.5..2.0`, `0.0..0.35`) whose upper bound deliberately includes vanilla 1.18.2's `2.0` source temperature; Gummy Jungle supplies a tropical window (`0.7..2.0`, `0.7..1.0`); Caramel Bogs adds a saturated warm-wet window (`0.5..1.2`, `0.75..1.0`); Sherbet Dunes and Candy-Cane Badlands supply the dry extreme (`1.5..2.0`, `0.0..0.2`). | Main | 1/3 | Revision 26 retains all fifteen selector contracts. Fixed-seed fresh/reload selected Soda Ocean through its broad source-inclusive window and retained its `0.5/0.5` output climate. A prior diagnostic fresh world with Waffle's maximum at `1.4` found no match; expanding it to the vanilla Savanna source boundary `2.0` selected the biome, proving selectors evaluate source climate. Exact boundary fixtures for every range remain. |
| OS-048 | Surface top block | Use icing turf, sponge, crumb sand, fudge crust, meringue, elastic Gummy, sticky Caramel Crust, four-colour Sherbet, soft dark Liquorice Loam, bright Candied Soil, bright Popped-Corn Turf and two distinct Wafer signatures. Gingerbread Hearthlands and Soda Ocean use gravity-affected Biscuit Crumbs, Cookie Forest uses Chocolate Sponge, Peppermint Pinewoods, Marshmallow Peaks and Ice-Cream Tundra use Icing Layers, Cupcake Gardens uses solid Icing, Liquorice Darkwood uses Liquorice Loam, Lollipop Orchards uses Candied Soil, Popcorn Prairie uses Popped-Corn Turf beneath its renewable kernel patches, Gummy Jungle uses Gummy Blocks beneath its bounce-grove ecology, Caramel Bogs uses Caramel Crust beneath its mangroves, Sherbet Dunes uses Raspberry Sherbet Powder beneath its fossils, Candy-Cane Badlands uses Wafer Rock beneath its hoodoos, and Waffle Plateaus uses visibly gridded Wafer Blocks. | Main | 1/3/4/5 | Revision-26 declarations and direct tests retain every named top material. Fixed-seed fresh/reload Soda sampling retained 9,136 Biscuit-Crumb cells across 1,865 local Soda-Ocean columns, verifying final generated output rather than treating JSON alone as runtime proof. |
| OS-049 | Surface filler block and depth | Put Chocolate Sponge four blocks below Hearthlands crumbs, Gummy Jungle, Caramel Bogs, Cupcake Gardens, Lollipop Orchards and Popcorn Prairie, and five below Cookie Forest and Liquorice Darkwood; put four blocks of Biscuit Crumbs below Soda Ocean; put five blocks of Peppermint Rock below Pinewoods icing, five blocks of Marshmallow below Peaks icing, five blocks of solid Icing below Tundra icing, five blocks of Lemon Sherbet Powder below Dunes, seven blocks of Candy-Cane Pillar below Badlands mesa tops, and six blocks of Wafer Rock below Waffle-Plateau grids. | Main | 1/3/4/5 | Revision 26 retains every declared depth and direct tests prove each exact declaration. Fixed-seed fresh/reload Soda sampling retained the same 9,136 Biscuit-Crumb cells beneath and around its natural Wafer Reef Nursery. |
| OS-050 | Underwater surface block | Use Biscuit Crumbs beneath Soda Ocean, Marshmallow Peaks, Waffle Plateaus and Popcorn Prairie, Blueberry Gummy beneath Gummy Jungle water, Raspberry Gummy beneath Cupcake Gardens and Lollipop Orchards, vertical Liquorice Root beneath Darkwood fluid, Caramel Crust beneath Caramel-Bogs Lemonade, Orange Sherbet Powder beneath Dunes fluid, Peppermint Rock beneath Badlands fluid, Frozen Lemonade beneath Ice-Cream Tundra fluid, and later custard sediment along Custard Coast. | Main | 3 | Revision 26 retains all twelve live biome fields and direct profile tests retain every control; Soda fresh/reload generation proved the final Biscuit-Crumb ocean floor and complete Wafer-Reef persistence. This declaration is independent of the separately shelved automatic `ice_block` runtime in OS-056. |
