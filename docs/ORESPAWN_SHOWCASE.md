...
| OS-044 | Weighted output biomes | Gingerbread Hearthlands enters the Overworld-land palette at weight `2.5`, alongside Candy Plains and above the `2.0` Cookie Forest, `1.5` Peppermint Pinewoods, `1.5` Caramel Bogs, `1.25` Gummy Jungle, `1.25` Sherbet Dunes, `1.25` Candy-Cane Badlands, `1.25` Cupcake Gardens, `1.0` Marshmallow Peaks, `1.0` Ice-Cream Tundra and `0.75` Waffle Plateaus; later Jellybean islands become an additional entry. | Main | 3 | The revision-22 profile retains every populated weight, both generated adventure templates are identical outside the thirteen intended BaseMetals ore additions, and fixed-seed generation selected Cupcake Gardens and Waffle Plateaus. Weight affects candidates that overlap for the same source; it is not falsely presented as a global rarity promise for disjoint similar-biome sets. |
| OS-045 | Similar-biome matching | Gingerbread Hearthlands maps optionally to Plains, Sunflower Plains, and Meadow; Cookie Forest to Forest, Flower Forest, and Birch Forest; Peppermint Pinewoods to Snowy Taiga, Taiga, and Old-Growth Pine Taiga; Gummy Jungle to Bamboo Jungle, Jungle, and Sparse Jungle; Caramel Bogs to Swamp; Sherbet Dunes to Desert; Candy-Cane Badlands to Badlands, Eroded Badlands and Wooded Badlands; Marshmallow Peaks to Jagged Peaks, Frozen Peaks, Stony Peaks, Snowy Slopes and Grove; Ice-Cream Tundra to Snowy Plains, Ice Spikes and Snowy Beach; Waffle Plateaus to Savanna Plateau, Windswept Savanna and Savanna; Cupcake Gardens to Sunflower Plains, Flower Forest and Meadow. Each hint remains optional rather than becoming a hard dependency. | Main | 1/3 | Revision 22 retains all eleven hint sets with empty required-hint lists; fixed-seed worlds prove the optional Cupcake-garden and Savanna families can select their new outputs. A missing optional-hint fixture remains for the Sampler. |
...
| OS-047 | Temperature and downfall ranges | Gingerbread Hearthlands demonstrates a temperate selector (`0.4..1.2` temperature, `0.25..0.8` downfall); Cookie Forest narrows the wet edge (`0.15..1.5`, `0.55..1.0`); Cupcake Gardens adds a temperate wet garden window (`0.3..1.2`, `0.35..1.0`); Peppermint Pinewoods supplies a cold/wet window (`-2.0..0.3`, `0.35..1.0`); Marshmallow Peaks broadens the cold mountain selector (`-2.0..0.35`, `0.0..1.0`); Ice-Cream Tundra adds a cold-plains window (`-2.0..0.2`, `0.0..0.8`); Waffle Plateaus supplies a dry Savanna selector (`0.5..2.0`, `0.0..0.35`) whose upper bound deliberately includes vanilla 1.18.2's `2.0` source temperature; Gummy Jungle supplies a tropical window (`0.7..2.0`, `0.7..1.0`); Caramel Bogs adds a saturated warm-wet window (`0.5..1.2`, `0.75..1.0`); Sherbet Dunes and Candy-Cane Badlands supply the dry extreme (`1.5..2.0`, `0.0..0.2`). | Main | 1/3 | Revision 22 retains all eleven selector contracts. A diagnostic fresh world with Waffle's maximum at `1.4` found no match; expanding it to the vanilla Savanna source boundary `2.0` selected the biome and persisted it on reload, proving selectors evaluate source climate rather than the child biome's overridden climate. The Cupcake fixed world separately selected and persisted its source-inclusive garden window. Exact boundary fixtures for every range remain. |
| OS-048 | Surface top block | Use icing turf, sponge, crumb sand, fudge crust, meringue, elastic Gummy, sticky Caramel Crust, four-colour Sherbet and two distinct Wafer signatures. Gingerbread Hearthlands uses gravity-affected Biscuit Crumbs, Cookie Forest uses Chocolate Sponge, Peppermint Pinewoods, Marshmallow Peaks and Ice-Cream Tundra use Icing Layers, Cupcake Gardens uses solid Icing, Gummy Jungle uses Gummy Blocks beneath its bounce-grove ecology, Caramel Bogs uses Caramel Crust beneath its mangroves, Sherbet Dunes uses Raspberry Sherbet Powder beneath its fossils, Candy-Cane Badlands uses Wafer Rock beneath its hoodoos, and Waffle Plateaus uses visibly gridded Wafer Blocks. | Main | 1/3/4/5 | Revision-22 declarations and direct tests retain every named top material. The Cupcake fixed-seed fresh/reload audit retained 871 Icing tops among 923 nearby Cupcake columns, while the Waffle audit retained 1,284 Wafer tops among 2,004 Waffle columns, verifying final generated output rather than treating JSON alone as runtime proof. |
| OS-049 | Surface filler block and depth | Put Chocolate Sponge four blocks below Hearthlands crumbs, Gummy Jungle, Caramel Bogs and Cupcake Gardens, and five below Cookie Forest; put five blocks of Peppermint Rock below Pinewoods icing, five blocks of Marshmallow below Peaks icing, five blocks of solid Icing below Tundra icing, five blocks of Lemon Sherbet Powder below Dunes, seven blocks of Candy-Cane Pillar below Badlands mesa tops, and six blocks of Wafer Rock below Waffle-Plateau grids. | Main | 1/3/4/5 | Revision 22 retains every declared depth and direct tests prove the Cupcake and Waffle bands alongside every earlier exact declaration; fresh/reload sampling retained 9,413 nearby Cupcake Chocolate-Sponge cells and the same 21,742 Waffle Wafer-Rock cells. |
| OS-050 | Underwater surface block | Use Biscuit Crumbs beneath Soda Ocean, Marshmallow Peaks and Waffle Plateaus, Blueberry Gummy beneath Gummy Jungle water, Raspberry Gummy beneath Cupcake Gardens, Caramel Crust beneath Caramel-Bogs Lemonade, Orange Sherbet Powder beneath Dunes fluid, Peppermint Rock beneath Badlands fluid, Frozen Lemonade beneath Ice-Cream Tundra fluid, and later custard sediment along Custard Coast. | Main | 3 | Revision 22 retains all nine live biome fields; direct profile tests retain the Cupcake and Waffle fields and every earlier control. This declaration is independent of the separately shelved automatic `ice_block` runtime in OS-056. |
