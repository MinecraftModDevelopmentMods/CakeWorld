...
| ID | OreSpawn capability | CakeWorld example | Placement | Slice | Verification expectation |
|---|---|---|---|---|---|
| OS-034 | Forge biome registration helper | Start simple biomes with `copyAndRegister`; Gingerbread Hearthlands, Cookie Crumb Forest, Peppermint Pinewoods, Gummy Jungle, Caramel Bogs and Sherbet Dunes demonstrate copying complete Plains, Forest, Snowy-Taiga, Bamboo-Jungle, Swamp and Desert definitions while deliberately replacing climate, ambience and spawn roles. Use `blankAndRegister` only for intentionally complete advanced definitions. | Main | 1/3 | Direct registry tests prove Hearthlands `0.85/0.55`, Cookie Forest `0.7/0.8`, Pinewoods `-0.2/0.7`, Gummy Jungle `0.95/0.95`, Caramel Bogs `0.8/0.9` and Sherbet Dunes `2.0/0.0`; each retains its intended inherited source roles while substituting exact CakeWorld creatures. |
...
| OS-044 | Weighted output biomes | Gingerbread Hearthlands enters the Overworld-land palette at weight `2.5`, alongside common Candy Plains and above the `2.0` Cookie Forest, `1.5` Peppermint Pinewoods, `1.5` Caramel Bogs, `1.25` Gummy Jungle, `1.25` Sherbet Dunes, and less-common Marshmallow Peaks; later Cupcake Gardens or Jellybean islands become the rare classes. | Main | 3 | The revision-17 profile retains every populated weight. Fresh/reload sampling observed 2,642 Hearthlands, 3,471 Cookie-Forest, 5,329 Pinewoods, 3,695 Gummy-Jungle, 3,817 Caramel-Bogs and 3,833 Sherbet-Dunes columns; broader statistical tolerance remains part of the final palette audit. |
| OS-045 | Similar-biome matching | Gingerbread Hearthlands maps optionally to Plains, Sunflower Plains, and Meadow; Cookie Forest to Forest, Flower Forest, and Birch Forest; Peppermint Pinewoods to Snowy Taiga, Taiga, and Old-Growth Pine Taiga; Gummy Jungle to Bamboo Jungle, Jungle, and Sparse Jungle; Caramel Bogs to Swamp; Sherbet Dunes to Desert. Each hint remains optional rather than becoming a hard dependency. | Main | 1/3 | Revision 17 retains all six hint sets with empty required-hint lists; accepted fresh/reload fixed-world sampling observed every mapped CakeWorld biome, including 3,833 Sherbet-Dunes columns. A missing optional-hint fixture remains for the Sampler. |
...
| OS-047 | Temperature and downfall ranges | Gingerbread Hearthlands demonstrates a temperate selector (`0.4..1.2` temperature, `0.25..0.8` downfall); Cookie Forest narrows the wet edge (`0.15..1.5`, `0.55..1.0`); Peppermint Pinewoods supplies a cold/wet window (`-2.0..0.3`, `0.35..1.0`); Gummy Jungle supplies a tropical window (`0.7..2.0`, `0.7..1.0`); Caramel Bogs adds a saturated warm-wet window (`0.5..1.2`, `0.75..1.0`); Sherbet Dunes supplies the dry extreme (`1.5..2.0`, `0.0..0.2`). | Main | 1/3 | Revision 17 retains all six selector contracts and fresh/reload selection observes every biome; boundary fixtures at min/max and just outside them remain. |
| OS-048 | Surface top block | Use icing turf, sponge, crumb sand, fudge crust, meringue, elastic Gummy, sticky Caramel Crust and four-colour Sherbet signatures. Gingerbread Hearthlands uses gravity-affected Biscuit Crumbs, Cookie Forest uses Chocolate Sponge, Peppermint Pinewoods uses Icing Layers, Gummy Jungle uses Gummy Blocks beneath its bounce-grove ecology, Caramel Bogs uses Caramel Crust beneath its mangroves, and Sherbet Dunes uses Raspberry Sherbet Powder beneath its fossils. | Main | 1/3/4/5 | Revision-17 fresh/reload sampling retained every earlier surface plus 2,168 Raspberry-Sherbet tops across 3,833 Dunes columns, alongside green Candy, Marshmallow, Fudge and Meringue controls. |
| OS-049 | Surface filler block and depth | Put Chocolate Sponge four blocks below Hearthlands crumbs, Gummy Jungle and Caramel Bogs, five below Cookie Forest, five blocks of Peppermint Rock below Pinewoods icing, and five blocks of Lemon Sherbet Powder below Dunes. | Main | 1/3/4/5 | Revision 17 retains every declared depth; fresh/reload sampling exposed the earlier filler bands plus 17,538 Lemon-Sherbet cells in Dunes while all dry and realm controls remained green. |
| OS-050 | Underwater surface block | Use Biscuit Crumbs beneath Soda Ocean, Blueberry Gummy beneath Gummy Jungle water, Caramel Crust beneath Caramel-Bogs Lemonade, Orange Sherbet Powder beneath Dunes fluid, and later custard sediment along Custard Coast. | Main | 3 | Revision 17 retains all four live biome fields; fixed-world surface and active-profile tests retain the new Orange-Sherbet field while earlier Soda and Caramel wet surfaces remain green. A deliberately flooded Gummy fixture remains useful final presentation evidence. |
