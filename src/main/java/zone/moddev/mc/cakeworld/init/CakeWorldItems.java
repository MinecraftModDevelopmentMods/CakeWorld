...
import zone.moddev.mc.cakeworld.item.ExplorersCookbookItem;
import zone.moddev.mc.cakeworld.item.GuidedChorusFoodItem;
import zone.moddev.mc.cakeworld.item.JellybeanFishBucketItem;
import zone.moddev.mc.cakeworld.item.JellylotlBucketItem;
import zone.moddev.mc.cakeworld.item.LemonadeBottleItem;
import zone.moddev.mc.cakeworld.item.ReusableKitchenToolItem;
					...
					() -> new Item(new Item.Properties()
							...
							.food(new FoodProperties.Builder()
									...
									.effect(() -> new MobEffectInstance(
											...
											240), 1.0F)
									.build())));
	public static final RegistryObject<Item> STARLIGHT_PAVLOVA =
			ITEMS.register("starlight_pavlova",
					() -> new Item(new Item.Properties()
							.tab(CreativeModeTab.TAB_FOOD)
							.food(new FoodProperties.Builder()
									.nutrition(8)
									...
									.effect(() -> new MobEffectInstance(
											...
											300), 1.0F)
									.build())));
	public static final RegistryObject<Item> SKYBERRY_CANDYFLOSS =
			ITEMS.register("skyberry_candyfloss",
					() -> new Item(new Item.Properties()
							.tab(CreativeModeTab.TAB_FOOD)
							.food(new FoodProperties.Builder()
									.nutrition(6)
