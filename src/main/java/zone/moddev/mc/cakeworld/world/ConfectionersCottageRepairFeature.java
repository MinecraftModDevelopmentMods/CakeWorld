...
/**
 * Restores cottage slices after surface decoration without replacing its
 * one-time resident.
 */
public final class ConfectionersCottageRepairFeature
		extends Feature<NoneFeatureConfiguration> {
	public static final ResourceLocation ID =
			new ResourceLocation(CakeWorld.MODID,
					"confectioners_cottage_repair");
	public static final ConfectionersCottageRepairFeature FEATURE =
			new ConfectionersCottageRepairFeature();
	...
	private ConfectionersCottageRepairFeature() {
	...
	public boolean place(
		...
		ConfiguredStructureFeature<?, ?> cottage =
		...
		for (StructureStart start : starts) {
			BoundingBox cottageBounds =
					start.getBoundingBox();
			if (!start.isValid()
					|| !cottageBounds.intersects(
			...
			BlockPos centre = new BlockPos(
					...
					cottageBounds.minZ()
							+ ConfectionersCottageStructureFeature
									.CENTRE_OFFSET);
			ConfectionersCottageFeature.rebuildInBounds(
