...
/**
 * Surface placement for the Confectioner's Cottage.
 */
public final class ConfectionersCottageStructureFeature
		extends StructureFeature<JigsawConfiguration> {
	public static final int CENTRE_OFFSET = 8;

	public ConfectionersCottageStructureFeature() {
		super(JigsawConfiguration.CODEC,
				ConfectionersCottageStructureFeature::createPieces);
	}
