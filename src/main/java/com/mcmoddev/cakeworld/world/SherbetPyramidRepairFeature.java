...
/**
 * Restores Sherbet Pyramid slices after surface and vegetation features.
 */
public final class SherbetPyramidRepairFeature
		extends Feature<NoneFeatureConfiguration> {
	public static final ResourceLocation ID =
			new ResourceLocation(CakeWorld.MODID,
					"sherbet_pyramid_repair");
	public static final SherbetPyramidRepairFeature FEATURE =
			new SherbetPyramidRepairFeature();
	...
	private SherbetPyramidRepairFeature() {
	...
	public boolean place(
		...
		ConfiguredStructureFeature<?, ?> pyramid =
				world.registryAccess()
						.registryOrThrow(Registry
								.CONFIGURED_STRUCTURE_FEATURE_REGISTRY)
						.get(SherbetPyramidFeature
								.STRUCTURE_ID);
		if (pyramid == null) {
			return false;
		}
