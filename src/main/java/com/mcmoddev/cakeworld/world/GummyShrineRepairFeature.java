...
/**
 * Restores Gummy Shrine slices after forest surface and vegetation features.
 */
public final class GummyShrineRepairFeature
		extends Feature<NoneFeatureConfiguration> {
	public static final ResourceLocation ID =
			new ResourceLocation(CakeWorld.MODID,
					"gummy_shrine_repair");
	public static final GummyShrineRepairFeature FEATURE =
			new GummyShrineRepairFeature();
	...
	private GummyShrineRepairFeature() {
	...
	public boolean place(
		...
		ConfiguredStructureFeature<?, ?> shrine =
				world.registryAccess()
						.registryOrThrow(Registry
								.CONFIGURED_STRUCTURE_FEATURE_REGISTRY)
						.get(GummyShrineFeature
								.STRUCTURE_ID);
		if (shrine == null) {
			return false;
		}
		...
		for (StructureStart start : starts) {
			...
			BoundingBox shrineBounds =
					start.getBoundingBox();
			BlockPos centre = new BlockPos(
					shrineBounds.minX() + 7,
					shrineBounds.minY(),
					shrineBounds.minZ() + 7);
			GummyShrineFeature.rebuildInBounds(
