...
/**
 * Restores Caramel Cottage slices after forest surface and vegetation.
 */
public final class CaramelCottageRepairFeature
		extends Feature<NoneFeatureConfiguration> {
	public static final ResourceLocation ID =
			new ResourceLocation(CakeWorld.MODID,
					"caramel_cottage_repair");
	public static final CaramelCottageRepairFeature FEATURE =
			new CaramelCottageRepairFeature();
	...
	private CaramelCottageRepairFeature() {
		...
		for (StructureStart start : starts) {
			...
			BlockPos centre = new BlockPos(
					...
					cottageBounds.minZ()
							+ CaramelCottageStructureFeature
									.CENTRE_OFFSET);
			CaramelCottageFeature.rebuildInBounds(
